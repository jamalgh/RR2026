**\# Comprehensive Analysis of** \*Suits\* **(2011-2019)**

**\## Show Description**

\*Suits\* is an American legal drama television series created by Aaron Korsh that premiered on USA Network on June 23, 2011. The show ran for nine seasons with 134 total episodes, concluding on September 25, 2019.
...
\| **\*\*Season 1 Average\*\*** \| 4.16 million viewers \|

\| **\*\*Season 9 Average\*\*** \| 0.99 million viewers \|

\| **\*\*Peak Season\*\*** \| Season 1 (4.16M) \|

\| **\*\*Lowest Season\*\*** \| Season 9 (0.99M) \|

\| **\*\*Overall Change\*\*** \| -3.17M viewers (76.2% decline) \|

\| **\*\*Series Run\*\*** \| 2011-06-23 – 2019-09-25 \|
...
The viewership data reveals a clear declining trend throughout the show's nine-season run. Starting with a strong **\*\*4.16 million viewers\*\*** in Season 1, the show experienced its most significant drop between Seasons 2 and 3, losing **\*\*0.87 million viewers\*\*** (a **\*\*24.2% decrease\*\***).
...
The show launched strongly with **\*\*4.16 million viewers\*\*** in Season 1. While Season 2 saw a decline to **\*\*3.60 million viewers\*\*** (a decrease of **\*\*0.56 million\*\*** or **\*\*13.5%\*\***), the show maintained a solid audience base.

**\### Phase 2: Sharp Decline (Seasons 2-4)**

The most dramatic drop occurred between Season 2 and Season 3, where viewership fell by **\*\*0.87 million viewers\*\*** (**\*\*24.2% decrease\*\***), dropping from 3.60M to 2.73M. This trend continued into Season 4, which averaged **\*\*2.26 million viewers\*\***, representing a further decline of **\*\*0.47 million\*\*** (**\*\*17.2%\*\***) from Season 3.

**\### Phase 3: Gradual Erosion (Seasons 4-7)**

From Season 4 to Season 7, the show experienced steady but slower declines:

\- Season 4 to 5: **\*\*-0.25M\*\*** (-11.1%)

\- Season 5 to 6: **\*\*-0.41M\*\*** (-20.4%)

\- Season 6 to 7: **\*\*-0.30M\*\*** (-18.8%)

By Season 7, viewership had fallen to **\*\*1.30 million viewers\*\***, representing a **\*\*68.8% decrease\*\*** from the show's peak in Season 1.

**\### Phase 4: Final Seasons (Seasons 7-9)**

The final three seasons showed continued decline but at a slower rate:

\- Season 7 to 8: **\*\*-0.28M\*\*** (-21.5%), falling to 1.02M viewers

\- Season 8 to 9: **\*\*-0.03M\*\*** (-2.9%), ending at 0.99M viewers

Notably, Season 9 consisted of only 10 episodes compared to the typical 16, which may have affected the average.

**\## Statistical Summary**

\- **\*\*Total viewership loss\*\***: 3.17 million viewers from Season 1 to Season 9

\- **\*\*Percentage decline\*\***: 76.2% over nine seasons

\- **\*\*Average seasonal decline\*\***: 0.40 million viewers per season

\- **\*\*Largest single-season drop\*\***: 0.87M viewers (Season 2→3)

\- **\*\*Smallest decline\*\***: 0.03M viewers (Season 8→9)
...
1\. Wikipedia. "Suits (American TV series)." https://en.wikipedia.org/wiki/Suits\_(American_TV_series)
